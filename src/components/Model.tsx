      ...
      <View style={styles.model}>
        <View style={styles.innerContainer}>
          <TouchableOpacity
            testID="remove"
            onPress={() => {
              if (currentText == '') this.props.remove();
              else Alert.alert('Either add or remove the data');
            }}
          ...
          <View style={styles.middlecircle}>
            <View
              ...
              <TouchableOpacity
                ...
                <IconicIcon
                  name={
                    mickon ? 'mic-circle-outline' : 'mic-off-circle-outline'
                  }
                  size={hp(8)}
                  style={styles.mick}
                  color={'#fff'}
          ...
          <View style={style.addRetack}>
            ...
            <TouchableOpacity
              style={[style.addbtn, {backgroundColor: 'red'}]}
              testID="Retake"
              onPress={() => {
                this.onStartButtonPress();
              }}>
